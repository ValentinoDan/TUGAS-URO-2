...
# Membaca video
video = cv2.VideoCapture(r"C:\Users\ASUS\OneDrive\Dokumen\Matkul ITB\URO\Tugas Wajib & Bonus URO 2\Animasi bintang.mp4") 
...
# Jika ret bernilai False, video telah selesai digunakan, dan loop berhenti
    ...
    for contour in contours:
        ...
        if area > 150:  # Objek harus lebih besar dari 200
    ...
    cv2.imshow('Deteksi Bintang', frame) 
